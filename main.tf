...
resource "azurerm_linux_function_app" "fa" {
  ...
  app_settings = {
    ...
    sumo_collector_url_csv              = "@Microsoft.KeyVault(SecretUri=${data.azurerm_key_vault_secret.sumo_collector_url_csv.versionless_id})"
    sumo_collector_url_xlsx             = "@Microsoft.KeyVault(SecretUri=${data.azurerm_key_vault_secret.sumo_collector_url_xlsx.versionless_id})"
    sumo_category_csv                   = "@Microsoft.KeyVault(SecretUri=${data.azurerm_key_vault_secret.sumo_category_csv.versionless_id})"
    sumo_category_xlsx                  = "@Microsoft.KeyVault(SecretUri=${data.azurerm_key_vault_secret.sumo_category_xlsx.versionless_id})"
    environment                         = var.env
