...
resource "azurerm_linux_function_app" "fa" {
  ...
  app_settings = {
    ...
    billing_app_id           = "@Microsoft.KeyVault(SecretUri=${data.azurerm_key_vault_secret.defender_app_id.versionless_id})"
    billing_app_secret       = "@Microsoft.KeyVault(SecretUri=${data.azurerm_key_vault_secret.defender_app_secret.versionless_id})"
